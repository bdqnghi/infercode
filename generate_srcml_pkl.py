...
parser.add_argument("--output_path", default="java-small_pkl/training", type=str, help="Output path")

args = parser.parse_args()


# docker run --cpus=10 --rm -v $(pwd):/e --entrypoint pkl -it yijun/fast OJ_raw_train_test_val/val OJ_pkl_train_test_val/val_2

def generate_folder_pb(src_path, tgt_path, worker):
    cmd = "docker run --cpus=" + str(worker) +  " --rm -v $(pwd):/e -it yijun/fast bash pkl " + src_path + " " + tgt_path
